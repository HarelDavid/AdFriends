            ...
            <div>
                ...
                <div style={{
                    ...
                    {/*<p style={{fontSize: 16, textAlign: 'justify'}}>*/}
                        {/*AdFriend מאפשרת למשתמשים להפיץ ולנהל מבצעי "חבר מביא חבר" ושליחת כרטיסי ביקור וירטואליים תוך*/}
                        {/*שימוש*/}
                        {/*באפליקציית WhatsApp.*/}
                    {/*</p>*/}
                    <Paper style={{padding: 20, width: '100%'}}>
                        ...
                        <div style={{display: 'flex', alignItems: 'center', marginTop: 10}}>
                            ...
                            /> אני מאשר את &nbsp;<a target="_blank"
                                                    href="https://firebasestorage.googleapis.com/v0/b/adfriend-73789.appspot.com/o/AdFriend_%D7%AA%D7%A0%D7%90%D7%99_%D7%A9%D7%99%D7%9E%D7%95%D7%A9.pdf?alt=media&token=5085ffd3-a827-417f-a40f-ab0fde304d6c"
                                                    style={{color: '#555'}}>תנאי השימוש</a>
                        </div>
